# wheat.gd
# This component manages a wheat plant's growth cycle, particle effects, and harvest logic.
extends Node2D

# Preloaded scene for the wheat harvest item
...
func on_crop_harvesting() -> void:
	# Instantiate the wheat harvest item
